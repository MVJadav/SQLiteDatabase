...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplicationLaunchOptionsKey: Any]?) -> Bool {
        ...
        SQLite3Conn().CheckandCreateDatabse()
        setRootViewVC()
        return true
    }
    ...
    func setRootViewVC() {
        let objSplaceScreen     = ContactListVC(nibName: "ContactListVC", bundle: nil)
        let navigationController    = UINavigationController(rootViewController: objSplaceScreen)
        navigationController.navigationBar.barTintColor = Comman().UIColorFromRGB(rgbValue: 0x004080)
